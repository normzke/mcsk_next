            ...
            <div className="grid gap-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {news.published_at ? format(new Date(news.published_at), "PPP") : "Not published"}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium">Created At</p>
                <p className="text-sm text-muted-foreground">
                  {news.created_at ? format(new Date(news.created_at), "PPP") : format(new Date(news.createdAt), "PPP")}
                </p>
              </div>
              <div>
                <p className="text-sm font-medium">Last Updated</p>
                <p className="text-sm text-muted-foreground">
                  {news.updated_at ? format(new Date(news.updated_at), "PPP") : format(new Date(news.updatedAt), "PPP")}
                </p>
              </div>
