...
export function LicenseForm({ initialData, members, licenseTypes }: LicenseFormProps) {
  ...
  const form = useForm<LicenseFormValues>({
    ...
    defaultValues: {
      ...
      issuedAt: initialData?.issuedAt ? format(new Date(initialData.issuedAt), 'yyyy-MM-dd') : null,
      expiresAt: initialData?.expiresAt ? format(new Date(initialData.expiresAt), 'yyyy-MM-dd') : null,
    },
  })
